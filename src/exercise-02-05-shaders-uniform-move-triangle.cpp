...
int render() {
  ...
  const char* vertexShaderFilePath = "shaders/exercise-02-05-shader-vertex.glsl";
  const char* fragmentShaderFilePath = "shaders/exercise-02-01-shader-fragment.glsl";

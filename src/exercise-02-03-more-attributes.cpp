...
int render() {
  ...
  const char* vertexShaderFilePath = "shaders/exercise-02-03-shader-vertex.glsl";
  const char* fragmentShaderFilePath = "shaders/exercise-02-03-shader-fragment.glsl";

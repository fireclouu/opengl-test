...
int render() {
  ...
  const char* vertexShaderFilePath = "shaders/exercise-02-06-shader-vertex.glsl";
  const char* fragmentShaderFilePath = "shaders/exercise-02-06-shader-fragment.glsl";
